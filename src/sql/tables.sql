...
CREATE TABLE appusers OF appuser (
    ...
    updated_at DEFAULT CURRENT_TIMESTAMP, -- Date and time when the user account was last updated
    is_active DEFAULT TRUE,            -- Whether the user account is active
	is_verified DEFAULT FALSE          -- Whether the user's email or account is verified
);  
